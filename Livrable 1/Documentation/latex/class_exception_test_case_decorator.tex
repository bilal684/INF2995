...
\index{Exception\+Test\+Case\+Decorator@{Exception\+Test\+Case\+Decorator}!check\+Exception@{check\+Exception}}
\index{check\+Exception@{check\+Exception}!Exception\+Test\+Case\+Decorator@{Exception\+Test\+Case\+Decorator}}
\subsubsection[{\texorpdfstring{check\+Exception(\+Expected\+Exception\+Type \&e)}{checkException(ExpectedExceptionType &e)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Expected\+Exception $>$ virtual void {\bf Exception\+Test\+Case\+Decorator}$<$ Expected\+Exception $>$\+::check\+Exception (
\begin{DoxyParamCaption}
\item[{Expected\+Exception\+Type \&}]{e}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [private]}, {\ttfamily [virtual]}}\hypertarget{class_exception_test_case_decorator_aecb2895a975aacdcafdc3b625e2ca9c1}{}\label{class_exception_test_case_decorator_aecb2895a975aacdcafdc3b625e2ca9c1}


Called when the exception is caught. 

Should be overriden to check the exception. \index{Exception\+Test\+Case\+Decorator@{Exception\+Test\+Case\+Decorator}!run\+Test@{run\+Test}}
...
Calls the decorated test \hyperlink{class_exception_test_case_decorator_a3f78294d459a94f55413162d814f291d}{run\+Test()} and checks that an exception of type Expected\+Exception is thrown. Call \hyperlink{class_exception_test_case_decorator_aecb2895a975aacdcafdc3b625e2ca9c1}{check\+Exception()} passing the exception that was caught so that some assertions can be made if needed. 
...
\item 
Commun/\+Externe/cppunit/include/cppunit/extensions/Exception\+Test\+Case\+Decorator.\+h\end{DoxyCompactItemize}
