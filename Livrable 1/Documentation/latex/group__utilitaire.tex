...
{\footnotesize template$<$class T $>$ }\\static std\+::string \hyperlink{group__utilitaire_ga37fa66cf904b19e12643fa88cc8ee5d5}{Etat\+Open\+G\+L\+::obtenir\+Chaine\+Vecteur} (const T $\ast$v, int size)
...
static std\+::string \hyperlink{group__utilitaire_ga15a4ea49db400340eebc4862b6fbf759}{Etat\+Open\+G\+L\+::obtenir\+Chaine\+Booleen} (G\+Lboolean v)
\begin{DoxyCompactList}\small\item\em Fonction qui affiche une valeur booléenne d\textquotesingle{}Open\+GL. \end{DoxyCompactList}\item 
...
\textcolor{keyword}{private}:                                                       \(\backslash\)
    Classe(\textcolor{keyword}{const} Classe&);                                  \(\backslash\)
    Classe& \hyperlink{class_singleton_a0765f17c275d65bacc1aae955e9bfc95}{operator=}(\textcolor{keyword}{const} Classe&);                     \(\backslash\)
    friend \textcolor{keyword}{class }\hyperlink{class_singleton}{Singleton}< Classe >;                           \(\backslash\)
\end{DoxyCode}
...
Aucune 
\end{DoxyReturn}
\index{Utilitaire@{Utilitaire}!obtenir\+Chaine\+Booleen@{obtenir\+Chaine\+Booleen}}
\index{obtenir\+Chaine\+Booleen@{obtenir\+Chaine\+Booleen}!Utilitaire@{Utilitaire}}
\subsubsection[{\texorpdfstring{obtenir\+Chaine\+Booleen(\+G\+Lboolean v)}{obtenirChaineBooleen(GLboolean v)}}]{\setlength{\rightskip}{0pt plus 5cm}std\+::string Etat\+Open\+G\+L\+::obtenir\+Chaine\+Booleen (
\begin{DoxyParamCaption}
\item[{G\+Lboolean}]{v}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}, {\ttfamily [private]}}\hypertarget{group__utilitaire_ga15a4ea49db400340eebc4862b6fbf759}{}\label{group__utilitaire_ga15a4ea49db400340eebc4862b6fbf759}


Fonction qui affiche une valeur booléenne d\textquotesingle{}Open\+GL. 

Cette fonction retourne une chaîne représentant un attribut qui est une valeur booléenne.


\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em v} & \+: L\textquotesingle{}attribut booléen.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Une chaîne représentant l\textquotesingle{}attribut booléen. 
\end{DoxyReturn}
...
\end{DoxyReturn}
\index{Utilitaire@{Utilitaire}!obtenir\+Chaine\+Vecteur@{obtenir\+Chaine\+Vecteur}}
\index{obtenir\+Chaine\+Vecteur@{obtenir\+Chaine\+Vecteur}!Utilitaire@{Utilitaire}}
\subsubsection[{\texorpdfstring{obtenir\+Chaine\+Vecteur(const T $\ast$v, int size)}{obtenirChaineVecteur(const T *v, int size)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T $>$ std\+::string Etat\+Open\+G\+L\+::obtenir\+Chaine\+Vecteur (
\begin{DoxyParamCaption}
\item[{const T $\ast$}]{v, }
\item[{int}]{size}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}\hypertarget{group__utilitaire_ga37fa66cf904b19e12643fa88cc8ee5d5}{}\label{group__utilitaire_ga37fa66cf904b19e12643fa88cc8ee5d5}


Fonction qui retourne la chaîne d\textquotesingle{}un vecteur de valeurs. 

Cette fonction retourne une chaîne représentant un attribut qui est un tableau.


\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em v} & \+: Le tableau d\textquotesingle{}attributs. \\
\hline
\mbox{\tt in}  & {\em size} & \+: Le nombre d\textquotesingle{}attributs dans le tableau.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Une chaîne représentant le tableau d\textquotesingle{}attributs. 
\end{DoxyReturn}
