...
\begin{DoxyCompactList}\small\item\em Ajuste la fenêtre virtuelle pour respecter le rapport d\textquotesingle{}aspect. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Borne supérieure en Y de la fenêtre virtuelle. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Ajuste la fenêtre virtuelle pour respecter le rapport d\textquotesingle{}aspect. 

Permet d\textquotesingle{}ajuster les coordonnées de la fenêtre virtuelle en fonction de la clôture de façon à ce que le rapport d\textquotesingle{}aspect soit respecté.
