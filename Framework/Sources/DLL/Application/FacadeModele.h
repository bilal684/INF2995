...
public:
   ...
   /// Ajout de noeud
   void ajouterNoeudSimple(char* nom, int x, int y);
   ///Ajout d'un noeud a l'arbre de rendu avec un certain redimensionnement.
   void ajouterNoeudAvecScale(char* nom, int x1, int y1, int x2, int y2, bool estConcret);
   ...
   void deplacerSelection(int xDebut, int yDebut, int xFin, int yFin);
   /// permet un redimensionnement sur les objets selectionnes
   void scaleSelection(double facteurScale);
   ...
   void selectRectElastique(int X_debut, int Y_debut, int X_fin, int Y_fin, bool estEnfonce);
   void selectRectElastique1(int X_debut, int Y_debut, int X_fin, int Y_fin, bool estEnfonce);

   bool assignerPositionPourObjetSelectionne(double x, double y, double z);
   ...
   bool changerScalePourObjetSelectionne(double scale);
