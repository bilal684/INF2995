...
///
////////////////////////////////////////////////////////////////////////
void FacadeModele::ajouterNoeudSimple(char* nom, int x, int y)
{
	glm::dvec3 point;
	vue_->convertirClotureAVirtuelle(x, y, point);
	NoeudAbstrait* noeud = arbre_->ajouterNouveauNoeud(arbre_->NOM_TABLE, nom);
...
///
////////////////////////////////////////////////////////////////////////
void FacadeModele::ajouterNoeudAvecScale(char* nom, int x1, int y1, int x2, int y2, bool estConcret)
{
	...
	if (std::string(nom) != arbre_->NOM_SEGMENT)
	{
		noeud = arbre_->ajouterNouveauNoeud(arbre_->NOM_TABLE, nom);
	...
	// source :: http://stackoverflow.com/questions/15606842/getting-the-child-elements-in-tinyxml2 //  fonctionne environ comme ca !
					...
					elementXMLCourantLecture_ = elementXMLCourantLecture_->NextSiblingElement())
				{
					...
					if (typeNoeudString == arbre_->NOM_LIGNE) {
						...
						elementXMLCourantLecture_->QueryBoolAttribute("Selectionne", &selectionne);
						...
						noeudLigne->assignerSelection(selectionne);
							...
							elementXMLSegment_ = elementXMLSegment_->NextSiblingElement())
						{
							...
							elementXMLSegment_->QueryBoolAttribute("Selectionne", &selectionne);
						...
						noeud->assignerSelection(selectionne);
...
///
////////////////////////////////////////////////////////////////////////
void FacadeModele::selectionnerObjet(int mouseX, int mouseY, bool selectionUnique)
{
	glm::dvec3 point;
	vue_->convertirClotureAVirtuelle(mouseX, mouseY, point);
...
///
////////////////////////////////////////////////////////////////////////
void FacadeModele::selectRectElastique(int xDebut, int yDebut, int xFin, int yFin, bool estEnfonce)
{
	if (!estEnfonce)
	{
...
///
////////////////////////////////////////////////////////////////////////
bool FacadeModele::assignerPositionPourObjetSelectionne(double x, double y, double z)
{
	bool retour = false;
	int nombreNoeud = 0;
...
///
////////////////////////////////////////////////////////////////////////
bool FacadeModele::changerScalePourObjetSelectionne(double facteur)
{
	bool reponse = false;
	int nombreNoeud = 0;
	NoeudAbstrait* noeud = chercherNouedSelectionne(nombreNoeud);
...
///
////////////////////////////////////////////////////////////////////////
void FacadeModele::scaleSelection(double facteur)
{
...
///
////////////////////////////////////////////////////////////////////////
void FacadeModele::deplacerSelection(int xDebut, int yDebut, int xFin, int yFin)
{
	glm::dvec3 debut;
	glm::dvec3 fin;
