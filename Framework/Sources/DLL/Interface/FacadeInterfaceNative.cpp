...
extern "C"
{
	...
	{
		FacadeModele::obtenirInstance()->ajouterNoeudSimple(nom, x, y);
	}
	...
	{
		FacadeModele::obtenirInstance()->ajouterNoeudAvecScale(nom, x1, y1, x2, y2, estConcret);
	}
	...
	{
		FacadeModele::obtenirInstance()->selectionnerObjet(mouseX, mouseY, selectionUnique);
	...
	{
		FacadeModele::obtenirInstance()->deplacerSelection(xDebut, yDebut, xFin, yFin);
	}
	...
	{
		FacadeModele::obtenirInstance()->selectRectElastique(X_debut, Y_debut, X_fin, Y_fin, estEnfonce);
	}
	...
	{
		return FacadeModele::obtenirInstance()->assignerPositionPourObjetSelectionne(x, y, z);
	}
	...
	{
		return FacadeModele::obtenirInstance()->changerScalePourObjetSelectionne(scale);
	}
	...
	*/
	...
	{
		FacadeModele::obtenirInstance()->scaleSelection(facteurScale);
	}
