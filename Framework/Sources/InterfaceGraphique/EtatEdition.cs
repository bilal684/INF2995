...
namespace InterfaceGraphique
{
    ...
    abstract class EtatEdition
    {
        ...
        {
            bool estEnZoneSimulation = FonctionsNatives.verifierPositionCurseur(x, y);
    ...
    static partial class FonctionsNatives
    {
        ...
        [DllImport(@"Noyau.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ajouterNoeudSimple(string nom, int x, int y);

        [DllImport(@"Noyau.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ajouterNoeudAvecScale(string nom, int x1, int y1, int x2, int y2, bool estConcret);

        [DllImport(@"Noyau.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void reInitialiserScene();

        [DllImport(@"Noyau.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void selectionObjet(int mouseX, int mouseY, bool selectionUnique);

        [DllImport(@"Noyau.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void deplacerSelection(int xDebut, int yDebut, int xFin, int yFin);
